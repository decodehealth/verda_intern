...
--O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates.bam \
--CREATE_INDEX true \
--VALIDATION_STRINGENCY SILENT \
--M /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_dup_metrics.txt 
...
#skip-mapping-quality-transform: ON by default (false); this flag turns off the mapping quality 255 -> 60 read transformer
/usr/lib/gatk/gatk SplitNCigarReads -R /mnt/iquityazurefileshare1/GTFs/SNPs/Homo_sapiens.GRCh38.dna.primary_assembly.fa \
-I /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates.bam \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates_split.bam \
-skip-mq-transform false 
...
java -jar /mnt/iquityazurefileshare1/IQuity/GATK_Testing/gatk-workflows/picard.jar AddOrReplaceReadGroups \
--I=/mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates_split.bam \
--O=/mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates_split_labeled.bam \
--RGPL=illumina \
--RGPU=unit1 \
--RGLB=lib1 \
--RGSM=MS1-IQ00-11000 \
...
/usr/lib/gatk/gatk BaseRecalibrator \
-R /mnt/iquityazurefileshare1/GTFs/SNPs/Homo_sapiens.GRCh38.dna.primary_assembly.fa \
-I /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates_split_labeled.bam \
--use-original-qualities \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_recal_data_1.table \
...
#plots: the new plot shows how the recalibrated base qualities will match up to the base qualities empirically calculated by the BaseRecalibrator
#Comparing the “before” and “after” plots allows you to check the effect of the base recalibration process before you actually apply the recalibration to your sequence data
 /usr/lib/gatk/gatk gatk AnalyzeCovariates \
 -before /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_recal_data_1.table \
 -after /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_recal_data_2.table \
 -plots mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_analyze_covariates.pdf
...
-R /mnt/iquityazurefileshare1/GTFs/SNPs/Homo_sapiens.GRCh38.dna.primary_assembly.fa \
-I /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates_split_labeled.bam \
--bqsr-recal-file /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_recal_data.csv \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates_split_labeled_recal.bam \
...
#stand-call-conf: default is 30; the minimum phred-scaled confidence threshold at which variants should be called
/usr/lib/gatk/gatk --java-options "-Xms6000m -XX:GCTimeLimit=50 -XX:GCHeapFreeLimit=10" HaplotypeCaller \
-R /mnt/iquityazurefileshare1/GTFs/SNPs/Homo_sapiens.GRCh38.dna.primary_assembly.fa \
-I /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_seq_marked_duplicates_split_labeled.bam \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_raw_variants.vcf.gz \
...
-R /mnt/iquityazurefileshare1/GTFs/SNPs/Homo_sapiens.GRCh38.dna.primary_assembly.fa \
-V /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_raw_variants.vcf.gz \
-window 35 \
-cluster 3 \
-filter "FS > 30.0" --filter-name "FS" \
-filter "QD < 2.0" --filter-name "QD" \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_raw_variants_filtered.vcf.gz
...
-filter "FS > 30.0" --filter-name "FS" \
-filter "QD < 2.0" --filter-name "QD" \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_snps_filtered.vcf.gz
...
-V /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_raw_variants.vcf.gz \
-select-type indel \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_indels.vcf.gz

##1.9.1 Hard-filter indels on multiple expressions using VariantFiltration
/usr/lib/gatk/gatk VariantFiltration \
-R /mnt/iquityazurefileshare1/GTFs/SNPs/Homo_sapiens.GRCh38.dna.primary_assembly.fa \
-V /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_indels.vcf.gz \
-cluster 3 \
-window 35 \
-filter "FS > 30.0" --filter-name "FS" \
-filter "QD < 2.0" --filter-name "QD" \
-O /mnt/iquityazurefileshare1/Test/GATKTesting/MS1-IQ00-11000-P-NN_haplo_indels_filtered.vcf.gz
